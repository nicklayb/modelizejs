    ...
    _createClass(Model, [{
        ...
        value: function store(options) {
            ...
            return new Promise(function (resolve, reject) {
                _this.constructor._fetch(_this.constructor._getUnindexedUrl(), 'POST', _this.constructor._extractOptions(options)).then(function (object) {
                    _this.setAttributes(object);
                    resolve(_this);
                }).catch(function (err) {
                    return reject(err);
                });
