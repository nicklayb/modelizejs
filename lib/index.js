...
var Model = exports.Model = function () {
    ...
    _createClass(Model, [{
        ...
        value: function save(options) {
            ...
            var method = this.isStored ? 'PUT' : 'POST';
            var url = this.isStored ? this._getIndexedUrl() : this.constructor._getUnindexedUrl();
            return new Promise(function (resolve, reject) {
                _this.constructor._fetch(url, method, options).then(function (object) {
        ...
        value: function _fetch(url, type, options) {
            ...
            return new Promise(function (resolve, reject) {
                axios.request({
                    ...
                    return resolve(className.cast(response.data));
                }).catch(function (err) {
                    return reject(err);
                });
            });
